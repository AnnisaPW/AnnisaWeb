...
class Fun {
  ...
  static NumberFormat get formatRupiah => NumberFormat.simpleCurrency(
        decimalDigits: 0,
        locale: 'id',
        name: '',
      );
  ...
  static void showSnackBar({
    ...
    Get.snackbar(
      ...
      backgroundColor: Get.isDarkMode ? Colors.grey.shade800.withOpacity(0.7) : Colors.grey.shade100.withOpacity(0.6),
  ...
  static Future<bool> onWillPop() {
    ...
    bool isGreater() => now.difference(_curBackPressTime) > const Duration(seconds: 2);
    if (isInit() || isGreater()) {
  ...
  static void showBottomSheetWrap(BuildContext context, String title, Widget widget) {
