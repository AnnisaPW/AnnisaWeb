...
class PuzzleWithoutTimerGrid extends StatefulWidget {
  final double containerSide;
  const PuzzleWithoutTimerGrid({
    Key? key,
    required this.containerSide,
  }) : super(key: key);

  @override
  State<PuzzleWithoutTimerGrid> createState() => _PuzzleWithoutTimerGridState();
}

class _PuzzleWithoutTimerGridState extends State<PuzzleWithoutTimerGrid> {
